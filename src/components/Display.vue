...
export default {
  ...
  methods: {
    ...
    adjustFreq: function(adjustAmnt) {
      ...
      this.changeFreq(this.freq.value + clipped);
    },
    changeAmpl: function(ampl) {
      ...
      this.ampl.value = ampl;
      // Looks like gainNode handles the logarithmic behaviour of sound amplitude? 
    ...
    adjustAmpl: function(adjustAmnt) {
      ...
      this.changeAmpl(this.ampl.value + clipped);
    },
  },
  data: function() {
    return {
